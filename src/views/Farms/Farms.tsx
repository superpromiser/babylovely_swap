...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.blovelyPerBlock))
  ...
  return (
    <>
      <PageHeader>
        <Heading as="h1" scale="xxl" color="invertedContrast" mb="24px">
      ...
      <Page>
        <ControlContainer>
          ...
          <FilterContainer>
            <LabelWrapper>
              <Text color="#fff" textTransform="uppercase">{t('Sort by')}</Text>
              <Select
                options={[
                  // {
                  //   label: t('Hot'),
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <Text color="#fff" textTransform="uppercase">{t('Search')}</Text>
